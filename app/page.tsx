...
const features = [
  {
    ...
    description:
      "Keep all your important PDF files securely and easily accessible anytime, anywhere.",
    icon: GlobeIcon,
  },
  {
  ...
  },
  {
    ...
    description:
      "Our intelligent chatbot remembers previous interactios, providing a seamless and personalized experience.",
    icon: BrainCogIcon,
  },
  {
    name: "Store your PDF Documents",
  ...
  },
  {
    ...
    description:
      "Engage with your PDFs like never before using our intuitative and interactive viewer.",
    icon: EyeIcon,
  },
  {
    name: "Cloud Backup",
        ...
        <div className="flex flex-col justify-center items-center mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              ...
              questions, summarize content, and answer all your Qs. Idea for
